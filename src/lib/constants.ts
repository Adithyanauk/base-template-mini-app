...
export const APP_NAME = process.env.NEXT_PUBLIC_FRAME_NAME || "Base Guardian";
export const APP_DESCRIPTION = process.env.NEXT_PUBLIC_FRAME_DESCRIPTION || "Your transaction safety shield for Base network";
...
// Base Guardian specific constants
export const RISK_LEVELS = {
  SAFE: { color: 'green', score: 0-3, label: 'Safe' },
  RISKY: { color: 'yellow', score: 4-7, label: 'Risky' },
  DANGEROUS: { color: 'red', score: 8-10, label: 'Dangerous' }
} as const;
